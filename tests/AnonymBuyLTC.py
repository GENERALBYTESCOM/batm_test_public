...
def openBanknoteDropdown():
    if (has(Pattern("1722425469678.png").similar(0.71))):
        assertClick(Pattern("1722425469678.png").similar(0.95), "OPEN BANKNOTES DROPDOWN 100")
    elif (has(Pattern("1722427265172.png").similar(0.95))):
        assertClick(Pattern("1722427265172.png").similar(0.95), "OPEN BANKNOTES DROPDOWN 200")
    elif (has(Pattern("1722427299365.png").similar(0.95))):
        assertClick(Pattern("1722427299365.png").similar(0.95), "OPEN BANKNOTES DROPDOWN 500")
    elif (has(Pattern("1722427411838.png").similar(0.95))):
        assertClick(Pattern("1722427411838.png").similar(0.95), "OPEN BANKNOTES DROPDOWN 1000")
    elif (has(Pattern("1722427462571.png").similar(0.95))):
        assertClick(Pattern("1722427462571.png").similar(0.95), "OPEN BANKNOTES DROPDOWN 2000")
    elif (has(Pattern("1722427510166.png").similar(0.95))):
        assertClick(Pattern("1722427510166.png").similar(0.95), "OPEN BANKNOTES DROPDOWN 5000")
    else:
...
assertExists("1727774440040.png", "WHERE DO YOU WANT TO SEND PURCHASED CRYPTO CURRENCY? TEXT EXIST")
